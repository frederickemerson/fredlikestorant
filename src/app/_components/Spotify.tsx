    ...
    if (response.ok && response.headers.get('Content-Type')?.includes('application/json')) {
      ...
      return(
        ...
        xmlns='http://www.w3.org/2000/svg'>
            ...
            <span className="text-sm font-medium">{current.item.name}</span>
          </div>
        </PopoverTrigger>
          ...
          <div className="space-y-2"b-black>
             <div className="flex flex-row md:flex-row">
                ...
                <div className="flex flex-col m-2">
                    <h2 className="flex flex-wrap text-xl md:text-2xl lg:text-3xl font-bold">{current.item.name}</h2>
